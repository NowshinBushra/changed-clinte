...
const ByBrand = () => {
    return (
          ...
          <div className='mx-10 my-16'>
            ...
            <div className='grid place-items-center justify-items-center grid-cols-4 lg:grid-cols-4 py-6 text-center underline border-dashed border-2 rounded-3xl border-gray-300'>
            <Link to="https://shop.mattel.com/pages/fisher-price"><img className='w-56' src={b1} alt="" /><p className='mt-8'>Fisher-price</p></Link>
            <Link to="https://funko.com/"><img className='w-60' src={b2} alt="" /><p className='-mt-6'>Funko</p></Link>
